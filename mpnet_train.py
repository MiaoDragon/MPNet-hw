...
parser.add_argument('--output_size', type=int , default=2, help='dimension of the output vector')
...
parser.add_argument('--env_type', type=str, default='s2d', help='s2d for simple 2d')
